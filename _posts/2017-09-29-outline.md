...
- we run the [VISPDAT](http://pehgc.org/wp-content/uploads/2016/09/VI-SPDAT-v2.0-Single-US-Print.pdf) for unsheltered families.
...
- law enforcement (responding to emergency) did we call them?
- fire dept, EMS 
- social workers
...
## [Answering the phone](answering-phone)

- Pear Blossom Place 360-628-7343

- resources
	- other shelters
		- details on [CW shelter](cold-weather)
		- [coordinated entry](coordinated-entry), VISPDAT process
		- hours of operation
...
- our shelter
  - walk in cold weather shelter
  - [VISPDAT](documents/2015-VISPDAT.pdf) for long term
    - needs coordinated entry
    - hours of operation
- resources
  - other shelters
  - hot meals
...
>   minor vs major? When there are threats of violence, kicking someone out, physical
...
We “screen people” into shelter, completing full criminal background checks and Registered Sex Offender Checks on all adults. We will not allow anyone into shelter with violent offenses or arson. The Deputy and Executive Directors take close look at all background checks, and always think about the safety of families and volunteers.
...
“Shift Lead” line – is moving to shelter. It will now be answered
